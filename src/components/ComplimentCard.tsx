      ...
      <div className={`relative bg-white rounded-3xl shadow-lg p-8 transition-all duration-300 ${className} max-w-2xl w-full mx-auto border border-gray-100`}>
        <div className="flex items-start mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500-font-normal text-sm font-normal text-zinc-500">{character.show}</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div style={{
          letterSpacing: '-1px'
        }} className="text-xl :text-2xl font-regular text-gray-900-relaxed font-cereal">
            "{compliment}"
          </div>
        </div>
